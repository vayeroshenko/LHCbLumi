...
// World size
const G4double worldSizeX = 1.6*m;
const G4double worldSizeY = 1.6*m;
...
/////////////////////////// Detector outside beampipe ///////////////////////////////////////////////
const G4double sectorThicknessOut = 5.*mm;
const G4double innerSideOut = 5.*mm; //2. * (centerRadOut - VertHeightOut * TMath::Cos(angleOut)/2.) * TMath::Sin(TMath::Pi() / nSecOut) - absInnerSideOut*40;
const G4double outerSideOut = innerSideOut; //2. * (centerRadOut + VertHeightOut * TMath::Cos(angleOut)/2.) * TMath::Sin(TMath::Pi() / nSecOut) - absOuterSideOut*20;

...
const G4double coneFullHeight = 7 *mm;
...
const G4double pmt_tablet_rad   = pmt_center_rad + tablet_thickness / 2. + window_thickness / 2.;
const G4double pmt_cone_rad   = pmt_center_rad + coneFullHeight / 2. + window_thickness / 2. + 0.01*mm;
const G4double pmt_conemirror_rad   = pmt_center_rad + coneFullHeight / 2. + window_thickness / 2. + 1.01*mm;

//const G4double pmt_conemirr_rad   = pmt_center_rad - tablet_thickness / 2. - window_thickness / 2.;

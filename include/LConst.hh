...
const G4double moedal_z = -1500*mm;
const G4double moedal_y_max = -130*mm;
const G4double moedal_width = 1.25*m;
const G4double moedal_height = 0.75*m;
const G4double moedal_al_thickness = 2.*mm;

...
const G4double pmt_center_rad_1 = pmt_window_pos_z_1 * tan(IPangle);
...
//////////////////////////////////// Radiation Monitor ///////////////////////////////////////////////////
const G4double radmon_radius = 10. *mm;
const G4double radmon_heights = 120. *mm;

const G4double radmon_pos_x = - BPOuterRadius - 1* (2* radmon_radius);
const G4double radmon_pos_y = 0. *mm;
const G4double radmon_pos_z = pmt_window_pos_z + 3* (2* radmon_radius);

...
G4VPhysicalVolume* L_DetectorConstruction::DefineVolumes(){
    ...
    worldLogical->SetSensitiveDetector(LSD);
    ...
    //////////// CONE //////////////////////////////
        ...
        G4double coneFullHeight = LConst::coneFullHeight;
        G4double cylinderRadius = coneFullHeight * sin(LConst::saturatedAngle);
        G4double cylinderHeight = coneFullHeight;

        G4VSolid *cylinderSolid = new G4Tubs("cylinder",
                                            0,
                                            cylinderRadius,
                                            cylinderHeight/2.,
                                            0,
                                            360*deg);
        G4double coneRadius = coneFullHeight / tan(LConst::saturatedAngle / 2.);


        G4VSolid *coneSolid_ = new G4Cons("cone",
                                         0,                // inside radius at -Dz
                                         0,                // outside radius at -Dz
                                         0,                // inside radius at +Dz
                                         coneRadius,             // outside radius at +Dz
                                         coneFullHeight/2.,             // half length in z
                                         0,                // phi start
                                         360*deg);         // phi finish

        G4VSolid *coneSolid = new G4IntersectionSolid("coneSolid", coneSolid_, cylinderSolid);


        G4LogicalVolume *coneLogical = new G4LogicalVolume(coneSolid, SiO2, "cone");
        ...
        G4VSolid *coneMirrorSolid = new G4SubtractionSolid("coneMirror",
                                                            coneSolid,
                                                            coneSolid,
                                                            0,
        ...
        G4LogicalVolume *coneMirrorLogical = new G4LogicalVolume(coneMirrorSolid, AluminumMirr, "cone");
...
//    G4RotationMatrix *Ra = new G4RotationMatrix();
    ...
    G4VSolid *tabletOut = new G4Tubs(
                "tabletOut",
                0.,
                pmt_detector.radius,
                LConst::tablet_thickness / 2.,
                0.,
                twopi);
...
//        Ta->setZ((LConst::pmt_detector_rad*TMath::Cos(TMath::Pi() / LConst::pmt_n_channels)) * TMath::Sin(360./LConst::pmt_n_channels*j *deg));
        ...
        Ta->setX((LConst::pmt_tablet_rad) * TMath::Cos(360./LConst::pmt_n_channels*j *deg));
        Ta->setY(LConst::L1pozZ);
        Ta->setZ((LConst::pmt_tablet_rad) * TMath::Sin(360./LConst::pmt_n_channels*j *deg));
...
//        LTablet[j] = new G4LogicalVolume(tabletOut,
//                                              /*Vacuum*/SiO2,
//                                              name);
//        //        if (j == 0)
//        assembly->AddPlacedVolume(LTablet[j],Tr);
...
//        Ta->setZ((LConst::pmt_detector_rad*TMath::Cos(TMath::Pi() / LConst::pmt_n_channels)) * TMath::Sin(360./LConst::pmt_n_channels*j *deg));
        ...
        Ta->setX((LConst::pmt_cone_rad) * TMath::Cos(360./LConst::pmt_n_channels*j *deg));
        Ta->setY(LConst::L1pozZ);
        Ta->setZ((LConst::pmt_cone_rad) * TMath::Sin(360./LConst::pmt_n_channels*j *deg));
        ...
        *Ra = *Ra * RTilt;
        ...
        LCones[j] = new G4LogicalVolume(coneSolid,
                                             SiO2,
                                            name);
        //        if (j == 0)
        assembly->AddPlacedVolume(LCones[j],Tr);
...
//        Ta->setZ((LConst::pmt_detector_rad*TMath::Cos(TMath::Pi() / LConst::pmt_n_channels)) * TMath::Sin(360./LConst::pmt_n_channels*j *deg));
        ...
        Ta->setX((LConst::pmt_conemirror_rad) * TMath::Cos(360./LConst::pmt_n_channels*j *deg));
        Ta->setY(LConst::L1pozZ);
        Ta->setZ((LConst::pmt_conemirror_rad) * TMath::Sin(360./LConst::pmt_n_channels*j *deg));
        ...
        *Ra = *Ra * RTilt;
        ...
        LConeMirrors[j] = new G4LogicalVolume(coneMirrorSolid,
                                             AluminumMirr,
                                             name);
        //        if (j == 0)
        assembly->AddPlacedVolume(LConeMirrors[j],Tr);
    ...
    const G4int num2 = 36;
        ...
        */
        ...
        new G4LogicalSkinSurface("MirrorSurfT",
                     coneMirrorLogical, OpMirrorSurface);
